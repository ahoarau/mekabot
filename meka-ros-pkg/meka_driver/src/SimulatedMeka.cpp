...
#include "../include/meka_driver/SimulatedMeka.h"

namespace meka_driver
{

SimulatedMeka::SimulatedMeka() :
  AbstractMeka()
{
...
void SimulatedMeka::refreshEncoders()
{
...
bool SimulatedMeka::executeTrajectory(boost::shared_ptr<SpecifiedTrajectory> traj_ptr)
{
...
void SimulatedMeka::moveGripper(double openingAngle)
{
...
bool SimulatedMeka::moveJoint(int jointIndex, double turningAngle){
  ROS_ERROR("moveJoint() not yet implemented for SimulatedKatana!");
  return false;
}

bool SimulatedMeka::someMotorCrashed() {
  return false;
}

bool SimulatedMeka::allJointsReady() {
  return true;
}

bool SimulatedMeka::allMotorsReady() {
  return true;
}
