...
(cl:defmethod cl:initialize-instance :after ((m <M3OmnibaseJoy>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'M3OmnibaseJoy)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name m3meka_msgs-msg:<M3OmnibaseJoy> is deprecated: use m3meka_msgs-msg:M3OmnibaseJoy instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <M3OmnibaseJoy>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader m3meka_msgs-msg:x-val is deprecated.  Use m3meka_msgs-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <M3OmnibaseJoy>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader m3meka_msgs-msg:y-val is deprecated.  Use m3meka_msgs-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'yaw-val :lambda-list '(m))
(cl:defmethod yaw-val ((m <M3OmnibaseJoy>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader m3meka_msgs-msg:yaw-val is deprecated.  Use m3meka_msgs-msg:yaw instead.")
  (yaw m))

(cl:ensure-generic-function 'button-val :lambda-list '(m))
(cl:defmethod button-val ((m <M3OmnibaseJoy>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader m3meka_msgs-msg:button-val is deprecated.  Use m3meka_msgs-msg:button instead.")
  (button m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <M3OmnibaseJoy>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader m3meka_msgs-msg:z-val is deprecated.  Use m3meka_msgs-msg:z instead.")
  (z m))
