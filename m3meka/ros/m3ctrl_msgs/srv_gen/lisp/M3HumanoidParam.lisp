...
(cl:defmethod cl:initialize-instance :after ((m <M3HumanoidParam-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'M3HumanoidParam-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name m3ctrl_msgs-srv:<M3HumanoidParam-request> is deprecated: use m3ctrl_msgs-srv:M3HumanoidParam-request instead.")))
...
(cl:defmethod payload_mass-val ((m <M3HumanoidParam-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader m3ctrl_msgs-srv:payload_mass-val is deprecated.  Use m3ctrl_msgs-srv:payload_mass instead.")
  (payload_mass m))

(cl:ensure-generic-function 'payload_com-val :lambda-list '(m))
(cl:defmethod payload_com-val ((m <M3HumanoidParam-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader m3ctrl_msgs-srv:payload_com-val is deprecated.  Use m3ctrl_msgs-srv:payload_com instead.")
  (payload_com m))

(cl:ensure-generic-function 'payload_inertia-val :lambda-list '(m))
(cl:defmethod payload_inertia-val ((m <M3HumanoidParam-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader m3ctrl_msgs-srv:payload_inertia-val is deprecated.  Use m3ctrl_msgs-srv:payload_inertia instead.")
  (payload_inertia m))

(cl:ensure-generic-function 'use_velocities-val :lambda-list '(m))
(cl:defmethod use_velocities-val ((m <M3HumanoidParam-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader m3ctrl_msgs-srv:use_velocities-val is deprecated.  Use m3ctrl_msgs-srv:use_velocities instead.")
  (use_velocities m))
...
(cl:defmethod use_accelerations-val ((m <M3HumanoidParam-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader m3ctrl_msgs-srv:use_accelerations-val is deprecated.  Use m3ctrl_msgs-srv:use_accelerations instead.")
  (use_accelerations m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<M3HumanoidParam-request>)))
  ...
  "m3ctrl_msgs/M3HumanoidParamRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'M3HumanoidParam-request)))
  "Returns string type for a service object of type 'M3HumanoidParam-request"
  "m3ctrl_msgs/M3HumanoidParamRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <M3HumanoidParam-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'M3HumanoidParam-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name m3ctrl_msgs-srv:<M3HumanoidParam-response> is deprecated: use m3ctrl_msgs-srv:M3HumanoidParam-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<M3HumanoidParam-response>)))
  ...
  "m3ctrl_msgs/M3HumanoidParamResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'M3HumanoidParam-response)))
  "Returns string type for a service object of type 'M3HumanoidParam-response"
  "m3ctrl_msgs/M3HumanoidParamResponse")
