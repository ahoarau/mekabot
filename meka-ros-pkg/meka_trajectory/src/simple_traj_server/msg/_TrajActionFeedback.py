"""autogenerated by genmsg_py from TrajActionFeedback.msg. Do not edit."""
...
class TrajActionFeedback(roslib.message.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "simple_traj_server/TrajActionFeedback"
...
"""
  ...
  _slot_types = ['Header','actionlib_msgs/GoalStatus','simple_traj_server/TrajFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = simple_traj_server.msg.TrajFeedback()
    else:
      self.header = std_msgs.msg._Header.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = simple_traj_server.msg.TrajFeedback()
