"""autogenerated by genpy from meka_trajectory/TrajActionFeedback.msg. Do not edit."""
import sys
...
class TrajActionFeedback(genpy.Message):
  ...
  _type = "meka_trajectory/TrajActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','meka_trajectory/TrajFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = meka_trajectory.msg.TrajFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = meka_trajectory.msg.TrajFeedback()
