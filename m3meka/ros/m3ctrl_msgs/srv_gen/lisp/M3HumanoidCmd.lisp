...
(cl:defmethod cl:initialize-instance :after ((m <M3HumanoidCmd-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'M3HumanoidCmd-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name m3ctrl_msgs-srv:<M3HumanoidCmd-request> is deprecated: use m3ctrl_msgs-srv:M3HumanoidCmd-request instead.")))

(cl:ensure-generic-function 'chain-val :lambda-list '(m))
(cl:defmethod chain-val ((m <M3HumanoidCmd-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader m3ctrl_msgs-srv:chain-val is deprecated.  Use m3ctrl_msgs-srv:chain instead.")
  (chain m))

(cl:ensure-generic-function 'tq_desired-val :lambda-list '(m))
(cl:defmethod tq_desired-val ((m <M3HumanoidCmd-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader m3ctrl_msgs-srv:tq_desired-val is deprecated.  Use m3ctrl_msgs-srv:tq_desired instead.")
  (tq_desired m))

(cl:ensure-generic-function 'ctrl_mode-val :lambda-list '(m))
(cl:defmethod ctrl_mode-val ((m <M3HumanoidCmd-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader m3ctrl_msgs-srv:ctrl_mode-val is deprecated.  Use m3ctrl_msgs-srv:ctrl_mode instead.")
  (ctrl_mode m))

(cl:ensure-generic-function 'q_stiffness-val :lambda-list '(m))
(cl:defmethod q_stiffness-val ((m <M3HumanoidCmd-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader m3ctrl_msgs-srv:q_stiffness-val is deprecated.  Use m3ctrl_msgs-srv:q_stiffness instead.")
  (q_stiffness m))

(cl:ensure-generic-function 'q_desired-val :lambda-list '(m))
(cl:defmethod q_desired-val ((m <M3HumanoidCmd-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader m3ctrl_msgs-srv:q_desired-val is deprecated.  Use m3ctrl_msgs-srv:q_desired instead.")
  (q_desired m))

(cl:ensure-generic-function 'qdot_desired-val :lambda-list '(m))
(cl:defmethod qdot_desired-val ((m <M3HumanoidCmd-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader m3ctrl_msgs-srv:qdot_desired-val is deprecated.  Use m3ctrl_msgs-srv:qdot_desired instead.")
  (qdot_desired m))

(cl:ensure-generic-function 'q_slew_rate-val :lambda-list '(m))
(cl:defmethod q_slew_rate-val ((m <M3HumanoidCmd-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader m3ctrl_msgs-srv:q_slew_rate-val is deprecated.  Use m3ctrl_msgs-srv:q_slew_rate instead.")
  (q_slew_rate m))

(cl:ensure-generic-function 'pwm_desired-val :lambda-list '(m))
(cl:defmethod pwm_desired-val ((m <M3HumanoidCmd-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader m3ctrl_msgs-srv:pwm_desired-val is deprecated.  Use m3ctrl_msgs-srv:pwm_desired instead.")
  (pwm_desired m))

(cl:ensure-generic-function 'enable_motor-val :lambda-list '(m))
(cl:defmethod enable_motor-val ((m <M3HumanoidCmd-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader m3ctrl_msgs-srv:enable_motor-val is deprecated.  Use m3ctrl_msgs-srv:enable_motor instead.")
  (enable_motor m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<M3HumanoidCmd-request>)))
  ...
  "m3ctrl_msgs/M3HumanoidCmdRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'M3HumanoidCmd-request)))
  "Returns string type for a service object of type 'M3HumanoidCmd-request"
  "m3ctrl_msgs/M3HumanoidCmdRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <M3HumanoidCmd-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'M3HumanoidCmd-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name m3ctrl_msgs-srv:<M3HumanoidCmd-response> is deprecated: use m3ctrl_msgs-srv:M3HumanoidCmd-response instead.")))

(cl:ensure-generic-function 'response-val :lambda-list '(m))
(cl:defmethod response-val ((m <M3HumanoidCmd-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader m3ctrl_msgs-srv:response-val is deprecated.  Use m3ctrl_msgs-srv:response instead.")
  (response m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<M3HumanoidCmd-response>)))
  ...
  "m3ctrl_msgs/M3HumanoidCmdResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'M3HumanoidCmd-response)))
  "Returns string type for a service object of type 'M3HumanoidCmd-response"
  "m3ctrl_msgs/M3HumanoidCmdResponse")
