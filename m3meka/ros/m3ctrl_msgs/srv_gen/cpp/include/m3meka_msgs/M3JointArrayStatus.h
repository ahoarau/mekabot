/* Auto-generated by genmsg_cpp for file /home/meka/mekabot/ROS_API/m3meka/ros/m3meka_msgs/srv/M3JointArrayStatus.srv */
...
{
template<class ContainerAllocator> struct IsMessage< ::m3meka_msgs::M3JointArrayStatusRequest_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::m3meka_msgs::M3JointArrayStatusRequest_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
...
namespace message_traits
{
template<class ContainerAllocator> struct IsMessage< ::m3meka_msgs::M3JointArrayStatusResponse_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::m3meka_msgs::M3JointArrayStatusResponse_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
