...
#include <meka_teleop/meka_teleop_key.h>
...
void MekaTeleopKey::jointStateCallback(const sensor_msgs::JointState::ConstPtr& js)
{
...
bool MekaTeleopKey::matchJointGoalRequest(double increment)
{
...
void MekaTeleopKey::keyboardLoop()
{
...
bool MekaTeleopKey::send_gripper_action(int32_t goal_type)
{
  GHPEG goal;
...
{
  ros::init(argc, argv, "meka_teleop_key");

  meka_driver::MekaTeleopKey ktk;
