...
(cl:defmethod cl:initialize-instance :after ((m <M3LoadX6Status-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'M3LoadX6Status-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name m3ctrl_msgs-srv:<M3LoadX6Status-request> is deprecated: use m3ctrl_msgs-srv:M3LoadX6Status-request instead.")))

(cl:ensure-generic-function 'request-val :lambda-list '(m))
(cl:defmethod request-val ((m <M3LoadX6Status-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader m3ctrl_msgs-srv:request-val is deprecated.  Use m3ctrl_msgs-srv:request instead.")
  (request m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<M3LoadX6Status-request>)))
  ...
  "m3ctrl_msgs/M3LoadX6StatusRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'M3LoadX6Status-request)))
  "Returns string type for a service object of type 'M3LoadX6Status-request"
  "m3ctrl_msgs/M3LoadX6StatusRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <M3LoadX6Status-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'M3LoadX6Status-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name m3ctrl_msgs-srv:<M3LoadX6Status-response> is deprecated: use m3ctrl_msgs-srv:M3LoadX6Status-response instead.")))

(cl:ensure-generic-function 'base-val :lambda-list '(m))
(cl:defmethod base-val ((m <M3LoadX6Status-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader m3ctrl_msgs-srv:base-val is deprecated.  Use m3ctrl_msgs-srv:base instead.")
  (base m))

(cl:ensure-generic-function 'wrench-val :lambda-list '(m))
(cl:defmethod wrench-val ((m <M3LoadX6Status-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader m3ctrl_msgs-srv:wrench-val is deprecated.  Use m3ctrl_msgs-srv:wrench instead.")
  (wrench m))

(cl:ensure-generic-function 'adc_ext_0-val :lambda-list '(m))
(cl:defmethod adc_ext_0-val ((m <M3LoadX6Status-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader m3ctrl_msgs-srv:adc_ext_0-val is deprecated.  Use m3ctrl_msgs-srv:adc_ext_0 instead.")
  (adc_ext_0 m))

(cl:ensure-generic-function 'adc_ext_1-val :lambda-list '(m))
(cl:defmethod adc_ext_1-val ((m <M3LoadX6Status-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader m3ctrl_msgs-srv:adc_ext_1-val is deprecated.  Use m3ctrl_msgs-srv:adc_ext_1 instead.")
  (adc_ext_1 m))

(cl:ensure-generic-function 'adc_ext_2-val :lambda-list '(m))
(cl:defmethod adc_ext_2-val ((m <M3LoadX6Status-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader m3ctrl_msgs-srv:adc_ext_2-val is deprecated.  Use m3ctrl_msgs-srv:adc_ext_2 instead.")
  (adc_ext_2 m))

(cl:ensure-generic-function 'dig_ext_0-val :lambda-list '(m))
(cl:defmethod dig_ext_0-val ((m <M3LoadX6Status-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader m3ctrl_msgs-srv:dig_ext_0-val is deprecated.  Use m3ctrl_msgs-srv:dig_ext_0 instead.")
  (dig_ext_0 m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<M3LoadX6Status-response>)))
  ...
  "m3ctrl_msgs/M3LoadX6StatusResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'M3LoadX6Status-response)))
  "Returns string type for a service object of type 'M3LoadX6Status-response"
  "m3ctrl_msgs/M3LoadX6StatusResponse")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<M3LoadX6Status-response>)))
  ...
  (cl:format cl:nil "m3_msgs/M3BaseStatus base~%float32[6] wrench~%float32 adc_ext_0~%float32 adc_ext_1~%float32 adc_ext_2~%float32 dig_ext_0~%~%~%================================================================================~%MSG: m3_msgs/M3BaseStatus~%string name~%uint8 state~%int64 timestamp~%string rate~%string version~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'M3LoadX6Status-response)))
  "Returns full string definition for message of type 'M3LoadX6Status-response"
  (cl:format cl:nil "m3_msgs/M3BaseStatus base~%float32[6] wrench~%float32 adc_ext_0~%float32 adc_ext_1~%float32 adc_ext_2~%float32 dig_ext_0~%~%~%================================================================================~%MSG: m3_msgs/M3BaseStatus~%string name~%uint8 state~%int64 timestamp~%string rate~%string version~%~%~%~%"))
