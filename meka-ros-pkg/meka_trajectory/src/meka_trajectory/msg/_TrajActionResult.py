"""autogenerated by genpy from meka_trajectory/TrajActionResult.msg. Do not edit."""
import sys
...
class TrajActionResult(genpy.Message):
  ...
  _type = "meka_trajectory/TrajActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','meka_trajectory/TrajResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = meka_trajectory.msg.TrajResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = meka_trajectory.msg.TrajResult()
