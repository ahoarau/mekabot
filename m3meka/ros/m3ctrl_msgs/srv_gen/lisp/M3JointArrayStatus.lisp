...
(cl:defmethod cl:initialize-instance :after ((m <M3JointArrayStatus-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'M3JointArrayStatus-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name m3ctrl_msgs-srv:<M3JointArrayStatus-request> is deprecated: use m3ctrl_msgs-srv:M3JointArrayStatus-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<M3JointArrayStatus-request>)))
  ...
  "m3ctrl_msgs/M3JointArrayStatusRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'M3JointArrayStatus-request)))
  "Returns string type for a service object of type 'M3JointArrayStatus-request"
  "m3ctrl_msgs/M3JointArrayStatusRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <M3JointArrayStatus-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'M3JointArrayStatus-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name m3ctrl_msgs-srv:<M3JointArrayStatus-response> is deprecated: use m3ctrl_msgs-srv:M3JointArrayStatus-response instead.")))
...
(cl:defmethod motor_temp-val ((m <M3JointArrayStatus-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader m3ctrl_msgs-srv:motor_temp-val is deprecated.  Use m3ctrl_msgs-srv:motor_temp instead.")
  (motor_temp m))

(cl:ensure-generic-function 'amp_temp-val :lambda-list '(m))
(cl:defmethod amp_temp-val ((m <M3JointArrayStatus-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader m3ctrl_msgs-srv:amp_temp-val is deprecated.  Use m3ctrl_msgs-srv:amp_temp instead.")
  (amp_temp m))

(cl:ensure-generic-function 'current-val :lambda-list '(m))
(cl:defmethod current-val ((m <M3JointArrayStatus-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader m3ctrl_msgs-srv:current-val is deprecated.  Use m3ctrl_msgs-srv:current instead.")
  (current m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<M3JointArrayStatus-response>)))
  ...
  "m3ctrl_msgs/M3JointArrayStatusResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'M3JointArrayStatus-response)))
  "Returns string type for a service object of type 'M3JointArrayStatus-response"
  "m3ctrl_msgs/M3JointArrayStatusResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'M3JointArrayStatus)))
  ...
  "m3ctrl_msgs/M3JointArrayStatus")