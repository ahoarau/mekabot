"""autogenerated by genmsg_py from TrajActionResult.msg. Do not edit."""
...
class TrajActionResult(roslib.message.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "simple_traj_server/TrajActionResult"
...
"""
  ...
  _slot_types = ['Header','actionlib_msgs/GoalStatus','simple_traj_server/TrajResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = simple_traj_server.msg.TrajResult()
    else:
      self.header = std_msgs.msg._Header.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = simple_traj_server.msg.TrajResult()
