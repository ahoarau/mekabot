...
#define	BB_SPI_SS_A					LATBbits.LATB10		//RC2	OUTPUT	PIN27	SPI_SS_SEAS/
...
#define	BB_SPI_CLK_A				LATBbits.LATB11		//RC0	OUTPUT	PIN25	SPI_CLK_SEAS
...
#define	BB_SPI_DIO_A				LATBbits.LATB6		//RB5	INPUT	PIN41	SPI_DIO_SEAS
#define	BB_SPI_DIO_B				LATBbits.LATB6		//RB6	INPUT	PIN42	SPI_DIO_ENC
//#define BB_PIN_SPI_DIO_A			PORTBbits.RB5
#define BB_PIN_SPI_DIO_A			PORTBbits.RB6
...
#define BB_SPI_SET_MOSI_A	TRISBbits.TRISB6=0; ODCBbits.ODCB6=1; //Make pin output, open collector
#define BB_SPI_SET_MISO_A	TRISBbits.TRISB6=1; ODCBbits.ODCB6=0; //Make pin input, non open collector
