  ...
  AbstractMeka()
{
  ...
  test_speed_srv_  = nh.advertiseService("test_speed", &MekaDriver::testSpeedSrv, this);
}
 ...
 */
short inline MekaDriver::round(const double x)
{
  if (x >= 0)
    return (short)(x + 0.5);
  else
...
bool MekaDriver::testSpeedSrv(std_srvs::Empty::Request &request, std_srvs::Empty::Response &response)
{
  testSpeed();
  return true;
}

void MekaDriver::testSpeed()
{
  ros::Rate idleWait(5);
