...
AbstractMeka::AbstractMeka()
{
  ...
  if (!n.getParam("meka_joints", joint_names))
  {
...
void AbstractMeka::freezeRobot()
{
  // do nothing (can be overridden)
}

void AbstractMeka::refreshMotorStatus()
{
  // do nothing (can be overridden)
}
...
int AbstractMeka::getJointIndex(std::string joint_name)
{
...
std::vector<std::string> AbstractMeka::getJointNames()
{
  return joint_names_;
}

std::vector<int> AbstractMeka::getJointTypes()
{
  return joint_types_;
}

std::vector<std::string> AbstractMeka::getGripperJointNames()
{
  return gripper_joint_names_;
}

std::vector<int> AbstractMeka::getGripperJointTypes()
{
  return gripper_joint_types_;
}

std::vector<double> AbstractMeka::getMotorAngles()
{
  return motor_angles_;
}

std::vector<double> AbstractMeka::getMotorVelocities()
{
...
double AbstractMeka::getMotorLimitMax(std::string joint_name)
{
...
double AbstractMeka::getMotorLimitMin(std::string joint_name)
{
  for (size_t i = 0; i < motor_limits_.size(); i++)
  {
    if (motor_limits_[i].joint_name == joint_name)
