/* Auto-generated by genmsg_cpp for file /home/meka/mekabot/ROS_API/m3meka/ros/m3meka_msgs/srv/M3HumanoidCmd.srv */
...
{
template<class ContainerAllocator> struct IsMessage< ::m3meka_msgs::M3HumanoidCmdRequest_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::m3meka_msgs::M3HumanoidCmdRequest_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
...
namespace message_traits
{
template<class ContainerAllocator> struct IsMessage< ::m3meka_msgs::M3HumanoidCmdResponse_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::m3meka_msgs::M3HumanoidCmdResponse_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
